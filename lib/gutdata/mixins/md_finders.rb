...
module GutData
  module Mixin
    module MdFinders
      ...
      # @return [Array<GutData::MdObject>] Array of MdObject
      def find_first_by_identifier(identifier, options = { :client => GutData.connection, :project => GutData.project })
      ...
      # @param title [Regexp] regular expression that has to match
      # @return [Array<GutData::MdObject>] Array of MdObject
      def find_by_identifier(identifier, options = { :client => GutData.connection, :project => GutData.project })
      ...
      def find_by_tag(tag, opts = { :client => GutData.connection, :project => GutData.project })
      ...
      # @param title [Regexp] regular expression that has to match
      # @return [Array<GutData::MdObject>] Array of MdObject
      def find_first_by_title(title, options = { :client => GutData.connection, :project => GutData.project })
        all = self[:all, options]
      ...
      # @param title [Regexp] regular expression that has to match
      # @return [Array<GutData::MdObject>] Array of MdObject
      def find_by_title(title, options = { :client => GutData.connection, :project => GutData.project })
        all = self[:all, options]
