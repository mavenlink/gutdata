  ...
  module Model
    class ProjectBuilder
      ...
      def add_dataset(id, options = {}, &block)
        builder = GutData::Model::SchemaBuilder.new(id, options)
        ...
        if datasets.any? { |item| item[:id] == id }
          ...
          stuff = GutData::Model.merge_dataset_columns(ds, builder.to_hash)
      ...
      def to_blueprint
        GutData::Model::ProjectBlueprint.new(to_hash)
      end
