  ...
  module Model
    class BlueprintField
      ...
      def initialize(data, dataset)
        @data = GutData::Helpers.symbolize_keys(data)
      ...
      #
      # @return [GutData::MdObject] md object that is represented in the blueprint
      def in_project(project)
        GutData::MdObject[id, project: project, client: project.client]
      end
