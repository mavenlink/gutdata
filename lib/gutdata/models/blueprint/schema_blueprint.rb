...
module GutData
  module Model
    class SchemaBlueprint
      ...
      # Returns anchor
      #
      # @return [GutData::Model::AnchorBlueprintField] anchor on schema
      def anchor
        nil
      end
      ...
      #
      # @return [Array<GutData::Model::ReferenceBlueprintField>] refs on schema
      def references
        []
      end
      ...
      #
      # @return [Array<GutData::Model::FactBlueprintField>] facts on schema
      ...
      #
      # @return [Array<GutData::Model::AttributeBlueprintField>] attributes on schema
      ...
      #
      # @return [Array<GutData::Model::LabelBlueprintField>] labels on schema
      ...
      #
      # @return [Array<GutData::Model::BlueprintField>] all fields on schema
      def fields
        []
      end
      ...
      #
      # @return [Array<GutData::Model::AnchorBlueprintField | GutData::Model::AttributeBlueprintField>]
      ...
      #
      # @return [Array<GutData::Model::BlueprintField>]
      def broken_by
      ...
      # @return [GutData::Model::DatasetBlueprint] returns matching dataset or throws an error
      ...
      #
      # @return [Array<GutData::Model::SchemaBlueprint>] returns id
      def referenced_by
      ...
      # @return [String]
      def title
        data[:title] || GutData::Helpers.titleize(data[:id])
      end
      ...
      #
      # @param name [GutData::Model::DatasetBlueprint] Name of a field
