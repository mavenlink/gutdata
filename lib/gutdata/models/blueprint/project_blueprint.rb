...
module GutData
  module Model
    class ProjectBlueprint
      ...
      # @return [GutData::Model::ProjectBlueprint]
      class << self
        def from_json(spec)
          if spec.is_a?(String)
            if File.file?(spec)
      ...
      #
      # @param project [Hash | GutData::Model::ProjectBlueprint] Project blueprint
      # @param dataset [Hash | GutData::Model::DatasetBlueprint] Dataset blueprint
      # @param column_id [String] Column id
      # @return [Hash | GutData::Model::ProjectBlueprint] Returns changed blueprint
      ...
      #
      # @param project [Hash | GutData::Model::ProjectBlueprint] Project blueprint
      # @param dataset_name [GutData::Model::DatasetBlueprint | String | Hash] Dataset to be removed
      ...
      def self.remove_dataset(project, dataset_id)
        ...
        dupped_project = GutData::Helpers.deep_dup(project)
      ...
      # date dimensions
      #
      # @param project [GutData::Model::ProjectBlueprint | Hash] Project blueprint
      ...
      #
      # @param what [GutData::Model::ReferenceBlueprintField | String] Date dimension reference field to be replaced.
      # @param for_what [GutData::Model::ReferenceBlueprintField | String] Date dimension reference field to be used as a replacement.
      # @return [GutData::Model::ProjectBlueprint]
      ...
      #
      # @param project [GutData::Model::ProjectBlueprint | Hash] Project blueprint
      # @param name [GutData::Model::DatasetBlueprint | String | Hash] Dataset
      # @return [Boolean]
      ...
      #
      # @param project [GutData::Model::ProjectBlueprint | Hash] Project blueprint
      # @param obj [GutData::Model::DatasetBlueprint | String | Hash] Dataset
      # @param options [Hash] options
      # @return [GutData::Model::DatasetBlueprint]
      ...
      # GutData::Model::ProjectBuilder is passed in as the only parameter
      #
      # @return [GutData::Model::ProjectBlueprint] returns changed project blueprint
      def change(&block)
      ...
      #
      # @param options [Hash] options
      # @return [Array<GutData::Model::DatasetBlueprint>]
      ...
      #
      # @param a_dataset [Hash | GutData::Model::SchemaBlueprint] dataset to be added
      ...
      # @return [GutData::Model::ProjectBlueprint] returns project blueprint
      ...
      #
      # @param dataset [Hash | GutData::Model::SchemaBlueprint] dataset to be added
      ...
      #
      # @param id [GutData::Model::BlueprintField] column to be moved
      # @param from_dataset [Hash | GutData::Model::SchemaBlueprint] dataset from which the field should be moved
      # @param to_dataset [Hash | GutData::Model::SchemaBlueprint] dataset to which the field should be moved
      # @return [GutData::Model::ProjectBlueprint] returns project blueprint
      ...
      # @return [Array<Hash>]
      def date_dimensions
        ProjectBlueprint.date_dimensions(self).map { |dd| GutData::Model::DateDimension.new(dd, self) }
      end
      ...
      #
      # @param dataset [GutData::Model::DatasetBlueprint | Hash | String] Dataset
      ...
      #
      # @param a_blueprint [GutData::Model::DatasetBlueprint] Dataset blueprint to be merged
      # @return [GutData::Model::DatasetBlueprint]
      def dup
        ProjectBlueprint.new(GutData::Helpers.deep_dup(data))
      end
      ...
      def initialize(init_data)
        ...
        @data = GutData::Helpers.symbolize_keys(GutData::Helpers.deep_dup(some_data))
      ...
      #
      # @param project [GutData::Model::DatasetBlueprint | Hash | String] Dataset blueprint
      # @return [Array<Hash>]
      def lint(full = false)
        errors = []
        ...
        if full
          # GutData::Attributes.all(:full => true).select { |attr| attr.used_by}
        end
        errors
      end
      ...
      def suggest_reports(options = {})
        ...
        when :stupid
          ...
          reports.reduce([]) do |a, e|
            ...
            attrs.each do |attr|
              a << GutData::Report.create(:title => 'Fantastic report',
                                           :top => [attr],
                                           :left => metric)
            end
            a
      ...
      def refactor_split_df(dataset)
        ...
        new_dataset = GutData::Model::DatasetBlueprint.new({ type: :dataset, id: "#{o.id}_dim", columns: [] }, self)
