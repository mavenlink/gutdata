...
module GutData
  class Attribute < MdObject
    ...
    class << self
      ...
      def find_element_value(stuff, opts = { :project => GutData.project })
    ...
    def dimension
      ...
      GutData::Dimension[uri, client: client, project: project]
    end
    ...
    # @return [GutData::Label] Primary label
