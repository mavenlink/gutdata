...
module GutData
  class Report < GutData::MdObject
    ...
    class << self
      ...
      def create(options = { :client => GutData.connection, :project => GutData.project })
      ...
      def data_result(result, options = {})
        ...
        begin
          ...
          if GutData::Helpers.get_path(resp, %w(error component)) == 'MD::DataResult'
            raise GutData::UncomputableReport
          else
            raise e
          end
        end
    ...
    #
    # @param report_definition [GutData::ReportDefinition | String] Report definition to add. Either it can be a URI of a report definition or an actual report definition object.
    # @return [GutData::Report] Return self
    ...
    #
    # @return [GutData::ReportDefinition] Returns the newest report defintion
    def definition
    ...
    #
    # @return [Array<GutData::ReportDefinition>] Returns list of report definitions. Oldest comes first
    def definitions
    ...
    #
    # @return [GutData::Report] Returns self
    def delete
      defs = definitions
      super
      defs.peach(&:delete)
    ...
    #
    # @return [GutData::DataResult] Returns the result
    def execute(options = {})
      fail 'You have to save the report before executing. If you do not want to do that please use GutData::ReportDefinition' unless saved?
      result = client.post '/gdc/xtab2/executor3', 'report_req' => { 'report' => uri }
      GutData::Report.data_result(result, options.merge(client: client))
    end
    ...
    # GutData::ReportDefintion[]
    #
    # @param definition [String | GutData::ReportDefinition] Report defintion to remove
    # @return [GutData::Report] Returns report with removed definition
    def remove_definition(definition)
      a_def = GutData::ReportDefinition[definition, project: project, client: client]
      def_uri = a_def.uri
    ...
    #
    # @return [GutData::Report] Returns report with removed definitions
    ...
    # @return [GutData::ReportDefinition] Updated and saved report definition
    def update_definition(opts = { :new_definition => true }, &block)
      ...
      if opts[:new_definition]
        new_def = GutData::ReportDefinition.create(:client => client, :project => project)
