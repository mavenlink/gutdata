...
module GutData
  class Label < GutData::MdObject
    ...
    def values_count
      ...
      count = GutData::Helpers.get_path(results, %w(validElements paging total))
      count && count.to_i
    end

    # Gives an attribute of current label
    # @return [GutData::Attibute]
    def attribute
...
GutData::DisplayForm = GutData::Label
