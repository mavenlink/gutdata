...
module GutData
  module Model
    module FromWire
      ...
      # @return [GutData::Model::ProjectBlueprint] Manifest for a particular reference
      ...
      def self.parse_facts(stuff)
        ...
        facts.map do |fact|
          {}.tap do |f|
            ...
            f[:gd_data_type] = fact['fact']['dataType'] || GutData::Model::DEFAULT_FACT_DATATYPE
          end
        end
      end
      ...
      def self.parse_label(attribute, label, type)
        {}.tap do |l|
          ...
          l[:gd_data_type] = label['label']['dataType'] || GutData::Model::DEFAULT_ATTRIBUTE_DATATYPE
          l[:gd_type] = label['label']['type'] || GutData::Model::DEFAULT_TYPE
