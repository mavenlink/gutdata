...
module GutData
  class MdObject < Rest::Resource
    ...
    class << self
      ...
      #
      # @param obj [GutData::MdObject] what Object that should be replaced
      # @param mapping [Array[Array]] Array of mapping pairs.
      # @return [GutData::MdObject]
      ...
      #
      # @param obj [GutData::MdObject] Object that should be replaced
      # @param mapping [Array[Array]] Array of mapping pairs.
      # @return [GutData::MdObject]
      ...
      def find_replaceable_values(obj, mapping)
        values_to_replace = GutData::SmallGoodZilla.extract_element_uri_pairs(MultiJson.dump(obj.to_json))
    ...
    #
    # @param [GutData::MdObject] what Object that should be replaced
    # @param [GutData::MdObject] for_what Object it is replaced with
    ...
    # @return [GutData::MdObject] MdObject that has been saved as
