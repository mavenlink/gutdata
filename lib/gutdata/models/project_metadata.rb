...
module GutData
  class ProjectMetadata
    class << self
      def keys(opts = { :client => GutData.connection, :project => GutData.project })
        ProjectMetadata[:all, opts].keys
      end

      def [](key, opts = { :client => GutData.connection, :project => GutData.project })
      ...
      def key?(key, opts = { :client => GutData.connection, :project => GutData.project })
      ...
      def []=(key, opts = { :client => GutData.connection, :project => GutData.project }, val = nil)
        client, project = GutData.get_client_and_project(opts)
