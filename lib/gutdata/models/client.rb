  ...
  class Client < Rest::Resource
    ...
    class << self
        ...
        e = Enumerator.new do |y|
          loop do
            ...
            res['clients']['items'].each do |i|
              p = i['client']['project']
              tenant = client.create(GutData::Client, i.merge('domain' => domain))
              tenant.project = p
              y << tenant
            end
      ...
      def create(data = {}, options = {})
        ...
        tenant = client.create(GutData::Client, GutData::Helpers.deep_stringify_keys(CLIENT_TEMPLATE.merge(domain: domain)), domain: domain)
        tenant.tap do |s|
    ...
    #
    # @param a_project [String|GutData::Project] Id or an instance of a project
    # @return [GutData::Cliet] Returns the instance of the client
    ...
    #
    # @return [GutData::Project] Returns the instance of the client's project
    def project
    ...
    #
    # @return [GutData::Client] Returns the updated client object
    def reload!
      res = client.get(uri)
      @json = res
      self
    ...
    # @return [GutData::Client] Returns the instance of the client
    ...
    #
    # @return [GutData::Segment] Segment
    def segment
      segment_res = client.get(data['segment'])
      client.create(GutData::Segment, segment_res)
    end
    ...
    #
    # @return [GutData::Client] Client instance
    def save
      if uri
        client.put(uri, json)
      else
    ...
    #
    # @return [GutData::Client] Segment instance
    def delete
