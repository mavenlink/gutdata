...
module GutData
  class << self
    ...
    #
    # @param path The HTTP path on the GutData server (must be prefixed with a forward slash)
    #
    # ### Examples
    #
    #     GutData.get '/gdc/projects'
    #
    ...
    def upload_to_user_webdav(file, options = {})
      url = user_webdav_path({ :client => GutData.client }.merge(options))
    ...
    def user_webdav_path(options = {})
      client = GutData::Rest::Object.client({ :client => GutData.client }.merge(options))
