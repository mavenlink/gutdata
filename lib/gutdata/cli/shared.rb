...
module GutData
  module CLI
    ...
    program_desc 'GutData Ruby gem - a wrapper over GutData API and several useful abstractions to make your everyday usage of GutData easier.'

    version GutData::VERSION

    desc 'GutData user name'
    default_value nil
    arg_name 'gooddata-login'
    flag [:U, :username, :login]

    desc 'GutData password'
    default_value nil
    ...
    desc 'Server'
    default_value GutData::Helpers::AuthHelper.read_server
    arg_name 'server'
    flag [:s, :server]
